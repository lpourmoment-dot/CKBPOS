          ...
          <div style={{ marginTop:16, borderTop:'1px solid var(--border)', paddingTop:14 }}>
            ...
            <div style={{ marginTop:18, paddingTop:14, borderTop:'1px solid var(--border)' }}>
              ...
              <div style={{ fontSize:11, color:'var(--text-muted)', lineHeight:1.7, background:'var(--bg-hover)', padding:'8px 12px', borderRadius:6 }}>
                ðŸª <strong>MÃªme clÃ© sur toutes les machines du mÃªme commerce.</strong><br/>
                Machines avec des clÃ©s diffÃ©rentes s'ignorent mutuellement â€” mÃªme si elles sont sur le mÃªme WiFi.
              </div>
            </div>
          </div>
        )}
            ...
            <div style={{ display:'grid', gridTemplateColumns:'52px 1fr 110px 110px 80px auto', gap:6, alignItems:'end' }}>
              <div>
                ...
                <div style={{ display:'flex', flexDirection:'column', gap:4 }}>
                  ...
                  <div style={{ display:'flex', gap:6, alignItems:'center' }}>
                    <span style={{ fontSize:20, width:32, textAlign:'center' }}>{newMIcon || 'ðŸ“Œ'}</span>
                    <input className="form-input" value={newMIcon} onChange={e=>setNewMIcon(e.target.value)}
                      placeholder="ou tape un emojiâ€¦" style={{ fontSize:13, flex:1, padding:'5px 8px' }}/>
                  </div>
                </div>
              </div>
              <div>
              ...
              <div>
                ...
                <select className="form-input" value={newMDir} onChange={e=>setNewMDir(e.target.value)} style={{ fontSize:12, padding:'7px 10px' }}>
                  <option value="sortie">â–¼ Sai</option>
                  <option value="entree">â–² Entra</option>
                  <option value="perte">âš  Perde</option>
                </select>
              </div>
              <div>
