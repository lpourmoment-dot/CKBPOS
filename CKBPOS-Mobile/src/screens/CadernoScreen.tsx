...
const styles = StyleSheet.create({
  ...
  summaryValue: { fontSize: 16, fontWeight: 'bold', flexShrink: 1 },
  ...
  entryAmount: { fontWeight: '700', fontSize: 14, flexShrink: 1 },
  ...
  motivoText: { fontSize: 11, color: COLORS.textSecondary, flexShrink: 1 },
